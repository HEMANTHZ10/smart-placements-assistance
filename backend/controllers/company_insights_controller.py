...
async def add_company_insights_data(data: ChatbotModel):
    try:
...
async def add_all_company_insights_data(data_list: List[ChatbotModel]):
    try:
...
async def delete_all_company_insights_data():
    try:
